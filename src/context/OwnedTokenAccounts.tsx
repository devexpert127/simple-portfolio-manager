...
export type OwnedTokenAccountsContextT = {
  ...
  ownedTokenAccounts: Record<string, TokenAccount2[]>;
...
export const OwnedTokenAccountsProvider: React.FC = ({ children }) => {
  ...
  useEffect(() => {
    ...
    console.log('here is OwnedTokenAccounts provider')
    ...
    (async () => {
      ...
      try {
        ...
        const _ownedTokenAccounts = {} as Record<string, TokenAccount2[]>;
        if (resp?.value) {
